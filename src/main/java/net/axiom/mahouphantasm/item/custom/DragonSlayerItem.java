...
public class DragonSlayerItem extends MagicSwordItem {
    public DragonSlayerItem(SpellDataRegistryHolder[] spellDataRegistryHolders) {
        super(MahouToolTiers.DRAGONSLAYER, MahouToolTiers.DRAGONSLAYER.getAttackDamageBonus(), MahouToolTiers.DRAGONSLAYER.getSpeed(),
